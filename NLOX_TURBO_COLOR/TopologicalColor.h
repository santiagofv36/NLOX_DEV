...
#do i=1,10
    #do j=`i'+1,10
        ...
        id FFLink(`s',`i')*FFLink(`s',`j')*FFLink(`s',`k')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
        id FFLink(`s',`i')*FFLink(`s',`j')*FFLink(`k',`s')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
        
        id FFLink(`s',`i')*FFLink(`j',`s')*FFLink(`s',`k')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
        id FFLink(`s',`i')*FFLink(`j',`s')*FFLink(`k',`s')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
        
        id FFLink(`i',`s')*FFLink(`s',`j')*FFLink(`s',`k')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
        id FFLink(`i',`s')*FFLink(`s',`j')*FFLink(`k',`s')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
        
        id FFLink(`i',`s')*FFLink(`j',`s')*FFLink(`s',`k')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
        id FFLink(`i',`s')*FFLink(`j',`s')*FFLink(`k',`s')*FNode(cOla0,cOla0,cOla0,`s') = FNode(cOla`s'000`i',cOla`s'000`j',cOla`s'000`k',`s');
