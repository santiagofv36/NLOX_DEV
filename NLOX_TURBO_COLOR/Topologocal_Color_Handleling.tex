...
\begin{equation}
 ...
 \left(
%  -g^{\mu\nu}\left(\frac{1}{1-z_i(1-y_{ij,k})}+\frac{1}{1-z_j(1-y_{ij,k})}-2\right)
 -g^{\mu\nu}F_{ij,k}
 +
%  \left(\frac{D-2}{2}\right)\frac{(p_i^\mu z_i-p_j^\mu z_j)(p_i^\nu z_i-p_j^\nu z_j)}{p_i.p_j}  
 v_{ij,k}^\mu v_{ij,k}^\nu 
...
\begin{equation}
 ...
 -g^{\mu\nu}
 +
%  \frac{2}{p_i.p_j}(p_i^\mu z_i-p_j^\mu z_j)(p_i^\nu z_i-p_j^\nu z_j)
