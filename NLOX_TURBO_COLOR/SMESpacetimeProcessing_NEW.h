...
***     cannot be ghost diagrams associated to this final gluon line.
***
*******************************************************************************
...
*******************************************************************************
***
***    We then express 1/(pi.pj) in terms of C code generator DS terms
***
*******************************************************************************
...
repeat id DS(?args,x1?)*DS(?args,x2?) = DS(?args,x1+x2);
repeat id DS(p1?,p2?,x1?,x2?) = DS(p1+p2,x1,x2);
